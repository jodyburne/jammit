...
@media only screen and (max-width:480px) {
  ...
  <img
     height="auto" src="https://res.cloudinary.com/marianacloud/image/upload/v1564706054/jammit/jammit_logo-01_rnyo9k.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="200"
  />
  ...
  >
    <h5>Hello user!</h5>
      <p> Thanks you for joining Jammit. Click above to start playing:</p>
       <p align="center" style="color:#BDBDBD; line-height: 9px"> <a href="https://recast.ai?ref=newsletter" style="color: #3498DB;">
          LINK
        </a>
  </div>
